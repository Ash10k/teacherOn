...
public class proExperience_adapter extends ArrayAdapter {
    Context c;
    private List<recommendedTeacherResponse.TutorRequest.TeacherExperience> list;
    ...
    public proExperience_adapter(Context context, List objects) {
