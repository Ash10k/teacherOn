...
public class allListAdapterTeacherconnected extends RecyclerView.Adapter<allListAdapterTeacherconnected.MyViewHolder>  {

    private List<requirementResponseconnected.TutorRequest> arrayList, filteredList;
   ...
   // BeneficiaryList.CallBackData callBackData;
    ...
    public allListAdapterTeacherconnected(Context ctx, List<requirementResponseconnected.TutorRequest> arrayList) {
    ...
    public void updateData(List<requirementResponseconnected.TutorRequest> newData) {
    ...
    public interface OnItemClickListener {
        void onItemClick(requirementResponseconnected.TutorRequest item, int instruction);
    }
