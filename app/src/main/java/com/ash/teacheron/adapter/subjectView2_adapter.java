...
public class subjectView2_adapter extends ArrayAdapter {
    Context c;
    private List<recommendedProfile.TutorRequest.TeacherSubject> list;
    ...
    public subjectView2_adapter(Context context, List objects) {
