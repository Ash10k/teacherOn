...
public class educationCerti_adapter2 extends ArrayAdapter {
    Context c;
    private List<recommendedProfile.TutorRequest.TeacherCertification> list;
    ...
    public educationCerti_adapter2(Context context, List objects) {
