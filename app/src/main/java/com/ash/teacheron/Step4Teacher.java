...
import com.ash.teacheron.viewmodel.teacherVM.step4VModel;
...
public class Step4Teacher extends AppCompatActivity {
    ...
    private void addDegree() {
        String degreeType = jobdes.getText().toString();
    ...
    private void addChip(String degreeName, step4teacher.Degree degree, String degreeKey) {
    ...
    private void removeDegree(step4teacher.Degree degree, Chip chip, String degreeKey) {
