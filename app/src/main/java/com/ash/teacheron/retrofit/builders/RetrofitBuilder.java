...
public class RetrofitBuilder
{
    ...
    public static Retrofit build()
    {
        try
        {
            ...
            builder.connectTimeout(10, TimeUnit.MINUTES) // Increase connect timeout to 10 minutes
                    .writeTimeout(10, TimeUnit.MINUTES)   // Increase write timeout to 10 minutes
